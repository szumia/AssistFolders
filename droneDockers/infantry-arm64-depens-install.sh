...
install_onnx() {
	...
	wget https://github.com/microsoft/onnxruntime/releases/download/v1.12.1/onnxruntime-linux-aarch64-1.12.1.tgz
	tar -xvf onnxruntime-linux-aarch64-1.12.1.tgz
	cd onnxruntime-linux-aarch64-1.12.1
	cp -r ./lib/* /usr/local/lib
	cd ..
	cp ./onnxruntime-linux-aarch64-1.12.1 /usr/local/ -r
	ldconfig
	cd ..
#	rm -rf onnx_install
}
