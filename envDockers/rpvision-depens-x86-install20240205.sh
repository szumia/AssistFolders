...
install_mvsdk() {
	...
	wget https://raw.githubusercontent.com/szumia/AssistFolders/main/linuxSDK_V2.1.0.37.tar.gz	
	tar -xvf linuxSDK_V2.1.0.37.tar.gz
...
install_g2o() {
	...
	wget https://github.com/RainerKuemmerle/g2o/archive/refs/tags/20230223_git.zip
...
install_sophus() {
	...
	wget https://github.com/strasdat/Sophus/archive/refs/tags/1.22.10.zip
	unzip 1.22.10.zip
	cd Sophus-1.22.10/
	mkdir build && cd build
	cmake ..
